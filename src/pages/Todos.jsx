...
export const loader = async () => {
    ...
    const todos = await axios.get(`https://6661507263e6a0189fe93820.mockapi.io/todos`);
...
const Todos = () => {
    ...
    const handleCreateTodo = async (e) => {
        ...
        const response = await axios.post(`https://6661507263e6a0189fe93820.mockapi.io/todos`, newTodo);
